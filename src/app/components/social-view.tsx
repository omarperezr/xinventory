  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="text-xl font-bold text-foreground">Redes sociales</h1>
      ...
      <div className="flex flex-wrap gap-1 rounded-xl bg-secondary p-1">
        {TABS.map(({ key, label, icon: Icon, hint }) => (
          <button
            ...
            onClick={() => setTab(key)}
            title={hint}
            className={`flex h-11 shrink-0 items-center gap-2 rounded-lg px-4 text-sm font-semibold whitespace-nowrap transition-colors ${
              tab === key
