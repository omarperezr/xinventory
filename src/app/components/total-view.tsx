...
import { Trash2, Search, Save, RotateCcw, ShoppingCart, Minus, Plus, X, CreditCard, Banknote, DollarSign } from 'lucide-react';
        ...
        <Dialog open={isChangeModalOpen} onOpenChange={(open) => {
            ...
            <DialogContent className="sm:max-w-md bg-white border-red-100">
                ...
                <div className="py-8 text-center">
                    ...
                    <p className="text-4xl font-bold text-red-600 mt-2">${changeAmount.toFixed(2)}</p>
                </div>
            ...
            {savedCarts.length === 0 ? (
              ...
              <div className="space-y-3">
                {savedCarts.map(cart => (
                  ...
                  >
                    <div className="font-medium text-sm text-gray-900 mb-1">{cart.name}</div>
                    <div className="flex justify-between items-end text-xs text-gray-500">
                      <span>{format(new Date(cart.dateSaved), 'MMM dd, HH:mm')}</span>
